...
st.set_page_config(page_title="Emotion Based Music Recommendation System", layout="wide")
...
st.write("Welcome aboard!Music feels better when it matches your mood. This platform is designed to understand your emotions and recommend songs that align with your feelings. Experiment with the controls, explore new sounds, and enjoy a smarter way to listen to music.Step into a personalized music experience where your emotions guide the playlist. Choose your preferences, explore different moods, and allow our intelligent system to recommend songs that resonate with how you feel.")
st.markdown("##")
